 ...
 *           <element name="attachment" type="{http://www.gaeb.de/GAEB_DA_XML/DA84/3.3}tgNormalizedString" maxOccurs="unbounded" minOccurs="0"/>
 *         </choice>
 *       </sequence>
...
public class OriginalTgBoQText {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Text", namespace = "http://www.gaeb.de/GAEB_DA_XML/DA84/3.3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TextComplement", namespace = "http://www.gaeb.de/GAEB_DA_XML/DA84/3.3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "attachment", namespace = "http://www.gaeb.de/GAEB_DA_XML/DA84/3.3", type = JAXBElement.class, required = false)
    })
