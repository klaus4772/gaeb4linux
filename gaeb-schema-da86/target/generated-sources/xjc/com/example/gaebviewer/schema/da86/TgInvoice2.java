 ...
 *       <sequence>
 *         <element name="DP" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgDP"/>
 *         <element name="OWN" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgOWN" minOccurs="0"/>
 *         <element name="Requester" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgRequester" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="CTR" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgCTR" minOccurs="0"/>
 *         <sequence maxOccurs="unbounded" minOccurs="0">
 *           <element name="CnstSite" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgCnstSite"/>
 *           <element name="NotifSite" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgNotifSite" minOccurs="0"/>
 *         </sequence>
 *         <element name="AddText" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgAddText" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BoQ" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgBoQ" minOccurs="0"/>
 *         <element name="InvoiceHeader" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgInvoiceHeader" minOccurs="0"/>
 *         <element name="InvoiceCreator" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgInvoiceCreator" minOccurs="0"/>
 *         <element name="InvoiceRecipient" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgInvoiceRecipient" minOccurs="0"/>
 *         <element name="CheckNote" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgCheckNote" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="BudgetDept" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgNormalizedString" minOccurs="0"/>
 *         <element name="BookingNo" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgNormalizedString" minOccurs="0"/>
 *         <element name="QuantityDeterminationRemark" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgNormalizedString" minOccurs="0"/>
 *         <element name="InvoiceShare" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgInvoiceShare" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="Terms" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgCashDiscount" maxOccurs="3" minOccurs="0"/>
 *         <element name="PaymentMade" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgPaymentMade" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="InvoiceMadeOut" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgInvoiceMadeOut" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="TotalGross" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgDecimal_13_2" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
