 ...
 *       <sequence>
 *         <element name="Style" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgStyle" minOccurs="0"/>
 *         <choice maxOccurs="unbounded">
 *           <element name="Text" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgFTextTC" maxOccurs="unbounded" minOccurs="0"/>
 *           <element name="TextComplement" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgTextComplement" maxOccurs="unbounded" minOccurs="0"/>
 *           <element name="attachment" type="{http://www.gaeb.de/GAEB_DA_XML/DA86/3.3}tgNormalizedString" maxOccurs="unbounded" minOccurs="0"/>
 *         </choice>
 *       </sequence>
...
public class TgBoQText2 {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Text", namespace = "http://www.gaeb.de/GAEB_DA_XML/DA86/3.3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "TextComplement", namespace = "http://www.gaeb.de/GAEB_DA_XML/DA86/3.3", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "attachment", namespace = "http://www.gaeb.de/GAEB_DA_XML/DA86/3.3", type = JAXBElement.class, required = false)
    })
