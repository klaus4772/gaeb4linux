 ...
 * 
 */
@XmlType(name = "tgInvoiceShareType", namespace = "")
@XmlEnum
public enum TgInvoiceShareType {
     ...
     */
    public static TgInvoiceShareType fromValue(String v) {
        for (TgInvoiceShareType c: TgInvoiceShareType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
