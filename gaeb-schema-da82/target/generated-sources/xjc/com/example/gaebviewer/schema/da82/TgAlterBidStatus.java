 ...
 * 
 */
@XmlType(name = "tgAlterBidStatus", namespace = "")
@XmlEnum
public enum TgAlterBidStatus {
     ...
     */
    public static TgAlterBidStatus fromValue(String v) {
        for (TgAlterBidStatus c: TgAlterBidStatus.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
