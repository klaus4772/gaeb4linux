 ...
 *         <element name="th" type="{http://www.gaeb.de/GAEB_DA_XML/DA82/3.3}tgth" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="td" type="{http://www.gaeb.de/GAEB_DA_XML/DA82/3.3}tgtdTC" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
...
@XmlType(name = "tgtrTC", propOrder = {
    "thAndTd"
})
public class TgtrTC2 {

    @XmlElements({
        @XmlElement(name = "th", type = Tgth2 .class),
        @XmlElement(name = "td", type = TgtdTC2 .class)
    })
