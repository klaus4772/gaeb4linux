 ...
 * 
 */
@XmlType(name = "tgHoldOutType")
@XmlEnum
public enum TgHoldOutType2 {
     ...
     */
    public static TgHoldOutType2 fromValue(String v) {
        for (TgHoldOutType2 c: TgHoldOutType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
