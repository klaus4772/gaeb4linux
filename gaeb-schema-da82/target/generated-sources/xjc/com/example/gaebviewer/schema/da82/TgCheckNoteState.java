 ...
 * 
 */
@XmlType(name = "tgCheckNoteState", namespace = "")
@XmlEnum
public enum TgCheckNoteState {
     ...
     */
    public static TgCheckNoteState fromValue(String v) {
        for (TgCheckNoteState c: TgCheckNoteState.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
