 ...
 *         <element name="QDetermItem" type="{http://www.gaeb.de/GAEB_DA_XML/DA81/3.3}tgQDetermItem" maxOccurs="unbounded" minOccurs="0"/>
 *       </sequence>
 *     </restriction>
 *   </complexContent>
 * </complexType>
...
@XmlType(name = "tgQtyDeterm", propOrder = {
    "qty",
    "qDetermItem"
})
public class TgQtyDeterm2 {
    ...
    protected List<TgQDetermItem2> qDetermItem;
     ...
     */
    public List<TgQDetermItem2> getQDetermItem() {
        if (qDetermItem == null) {
