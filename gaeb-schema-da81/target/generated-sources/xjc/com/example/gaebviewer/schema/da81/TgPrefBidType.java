 ...
 * 
 */
@XmlType(name = "tgPrefBidType", namespace = "")
@XmlEnum
public enum TgPrefBidType {
     ...
     */
    public static TgPrefBidType fromValue(String v) {
        for (TgPrefBidType c: TgPrefBidType.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
