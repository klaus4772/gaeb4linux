 ...
 * 
 */
@XmlType(name = "tgSpecialType")
@XmlEnum
public enum TgSpecialType2 {
     ...
     */
    public static TgSpecialType2 fromValue(String v) {
        for (TgSpecialType2 c: TgSpecialType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
