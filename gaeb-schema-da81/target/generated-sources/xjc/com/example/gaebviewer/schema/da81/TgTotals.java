 ...
 *               <element name="DiscountAmt" type="{}tgDecimal_13_2"/>
 *             </choice>
 *             <element name="TotAfterDisc" type="{}tgDecimal_13_2"/>
 *           </sequence>
 *           <element name="TotalLSUM" type="{}tgDecimal_13_2"/>
 *         </choice>
 *         <element name="VAT" type="{}tgDecimal_5_2" minOccurs="0"/>
 *         <element name="TotalNet" type="{}tgDecimal_13_2" minOccurs="0"/>
 *         <element name="TotalNetUpComp" type="{}tgTotalNetUpComp" minOccurs="0"/>
 *         <element name="VATPart" type="{}tgVATPart" maxOccurs="unbounded" minOccurs="0"/>
 *         <element name="VATAmount" type="{}tgDecimal_13_2" minOccurs="0"/>
...
@XmlType(name = "tgTotals", namespace = "", propOrder = {
    "total",
    "discountPcnt",
    "discountAmt",
    "totAfterDisc",
...
public class TgTotals {
    ...
    protected TgTotalNetUpComp totalNetUpComp;
    /**
     * Umsatzsteuersatz
     * 
     */
    @XmlElement(name = "VATPart")
    protected List<TgVATPart> vatPart;
    /**
     * Umsatzsteuerbetrag
     * 
     */
     ...
     * @return
     *     possible object is
     *     {@link TgTotalNetUpComp }
     *     
     */
    public TgTotalNetUpComp getTotalNetUpComp() {
     ...
     */
    public void setTotalNetUpComp(TgTotalNetUpComp value) {
     ...
     */
    public List<TgVATPart> getVATPart() {
        if (vatPart == null) {
