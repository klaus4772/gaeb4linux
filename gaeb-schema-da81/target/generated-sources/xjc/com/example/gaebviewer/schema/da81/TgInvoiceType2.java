 ...
 * 
 */
@XmlType(name = "tgInvoiceType")
@XmlEnum
public enum TgInvoiceType2 {
     ...
     */
    public static TgInvoiceType2 fromValue(String v) {
        for (TgInvoiceType2 c: TgInvoiceType2 .values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
